import { isNpc, Npc } from '../../notify/notifyPropertyChanged';
 ...
 */
export function whenPropertyChanged<TObject, TProperty extends keyof TObject>(key: TProperty, notifyInitial?: boolean): OperatorFunction<IChangeSet<Npc<TObject>, TProperty>, TObject[TProperty]>;
export function whenPropertyChanged<TObject, TProperty extends keyof TObject>(value: Npc<TObject> | TProperty, key: TProperty | boolean, notifyInitial?: boolean, fallbackValue?: () => TObject[TProperty]) {
    if (isNpc(value)) {
        return whenChanged(value as Npc<TObject>, key as TProperty, notifyInitial, fallbackValue);
    } else {
        return function whenValueChangedOperator(source: Observable<IChangeSet<Npc<TObject>, TProperty>>) {
