...
export type Group<TObject, TKey, TGroupKey> = Iterable<TObject> & { key: TGroupKey; cache: IObservableCache<TObject, TKey> };
...
export class GroupChangeSet<TObject, TKey, TGroupKey>
    extends ChangeSet<Group<TObject, TKey, TGroupKey>, TGroupKey>
    implements IChangeSet<Group<TObject, TKey, TGroupKey>, TGroupKey> {
